...
const dictionaries: Record<DictionaryLanguage, Record<string, string>> = {
  en: {
    ...
    "settings.support.report.hint": "Click the 'Report a Bug' button in the bottom-right corner",
  ...
  "zh-Hans": {
    ...
    "settings.support.report.hint": "请点击右下角的 Bug 反馈按钮",
  ...
  "zh-Hant": {
    ...
    "settings.support.report.hint": "請點擊右下角的 Bug 回報按鈕",
  ...
  fr: {
    ...
    "settings.support.report.hint": "Cliquez sur le bouton 'Signaler un bug' en bas à droite",
  ...
  ru: {
    ...
    "settings.support.report.hint": "Нажмите кнопку 'Сообщить об ошибке' в правом нижнем углу",
    ...
    "settings.update.error": "Ошибка проверки обновлений",
  ...
  ja: {
    ...
    "settings.support.report.hint": "右下の「バグを報告」ボタンをクリックしてください",
  ...
  ko: {
    ...
    "settings.support.report.hint": "오른쪽 하단의 '버그 신고' 버튼을 클릭하세요",
