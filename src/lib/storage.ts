...
export const STORAGE_KEYS = {
  ...
  CHECK_PRERELEASE: "checkPrerelease", // boolean, default false
...
export const loadBoolean = async (
  key: string,
...
export function mergeTOC(cached: TOCNode[], fresh: TOCNode[]): TOCNode[] {
  ...
  const freshIndices = fresh
    .map((n) => getTurnIndex(n.id))
 ...
 */
export async function getAllCachedConversations(): Promise<
 ...
 */
export function debouncedSaveCachedConversation(
  conversation: CachedConversation
): void {
